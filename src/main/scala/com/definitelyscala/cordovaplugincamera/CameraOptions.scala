...
trait CameraOptions extends js.Object {
   ...
   */
  var destinationType: Double = js.native
  /**
   ...
   */
  var mediaType: Double = js.native
  /** Rotate the image to correct for the orientation of the device during capture. */
  var correctOrientation: Boolean = js.native
  /** Save the image to the photo album on the device after capture. */
  var saveToPhotoAlbum: Boolean = js.native
  /**
   ...
   *      BACK: 1
   */
  var cameraDirection: Double = js.native
  /** iOS-only options that specify popover location in iPad. Defined in CameraPopoverOptions. */
  var popoverOptions: CameraPopoverOptions = js.native
}